...
-(BOOL)createPersonWithFirstName:(NSString*)firstName lastName:(NSString*)lastName age:(NSInteger)age
{
    ...
    if (person!=nil) {
        ...
        person.age = @(age);//[NSNumber numberWithInteger:age];
...
{
    [self createPersonWithFirstName:@"John" lastName:@"Chen" age:33];
    [self createPersonWithFirstName:@"Lion" lastName:@"Chen" age:6];
    ...
    if ([persons count] > 0){
        ...
        for (CDPerson *thisPerson in persons){
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CoreData4" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CoreData4.sqlite"];
